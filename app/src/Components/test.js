...
//     const [dataTimeLen, setdataTimeLen] = useState(20);
//     const [eventsTimeLen, seteventsTimeLen] = useState(3600);
...
//             }
//             const DataResp = await DataFromServer([dataTimeLen, eventsTimeLen, currPmu], serverAddress + 'data-server');
...
//     }, [dataTimeLen, currPmu, eventsTimeLen]);
